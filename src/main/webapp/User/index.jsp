  ...
  <article>
    ...
    <div class="game1">
      ...
      <div class="game_bx" id="game_bx_1">
        <div class="card">
          <a href="<%=request.getContextPath()%>/User/De_xuat/gta_v.html"><img src="<%=request.getContextPath()%>/User/img/gta5.jpg"></a>
          <div class="content">
            <div class="left">
        ...
        <!--                1-->
        <div class="card">
          <a href="<%=request.getContextPath()%>/User/De_xuat/pubg.html"> <img src="<%=request.getContextPath()%>/User/img/pubg.webp"></a>
          <div class="content">
            <div class="left">
        ...
        <!--                2-->
        <div class="card">
          <a href="<%=request.getContextPath()%>/User/De_xuat/Counter_Strike.html"><img src="<%=request.getContextPath()%>/User/img/csgo.jpg"></a>
          <div class="content">
            <div class="left">
        ...
        <!--                3-->
        <div class="card">
          <a href="<%=request.getContextPath()%>/User/De_xuat/Age_of_Empires_IV.html"><img src="<%=request.getContextPath()%>/User/img/ageIV.jpg"></a>
          <div class="content">
            <div class="left">
        ...
        <!--                4-->
        <div class="card">
          <a href="<%=request.getContextPath()%>/User/De_xuat/WORLD_OF_WARSHIPS.html"><img src="<%=request.getContextPath()%>/User/img/wow.jpg"></a>
          <div class="content">
            <div class="left">
    ...
    <div class="game2">
      ...
      <div class="game_bx">
        <!--                1-->
        <div class="card">
          <a href="<%=request.getContextPath()%>/User/Most_Played/Goose_Goose.jsp"><img src="<%=request.getContextPath()%>/User/img/duck.jpeg" alt=""></a>
          <div class="content">
